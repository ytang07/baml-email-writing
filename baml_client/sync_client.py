...
class BamlSyncClient:
    ...
    def ExtractQuestions(
      ...
      mdl = create_model("ExtractQuestionsReturnType", inner=(List[types.Question], ...))
...
class BamlStreamClient:
    ...
    def ExtractQuestions(
        ...
        transcript: str,
        baml_options: BamlCallOptions = {},
    ) -> baml_py.BamlSyncStream[List[partial_types.Question], List[types.Question]]:
      __tb__ = baml_options.get("tb", None)
      if __tb__ is not None:
        tb = __tb__._tb
      else:
      ...
      mdl = create_model("ExtractQuestionsReturnType", inner=(List[types.Question], ...))
      partial_mdl = create_model("ExtractQuestionsPartialReturnType", inner=(List[partial_types.Question], ...))

      return baml_py.BamlSyncStream[List[partial_types.Question], List[types.Question]](
        raw,
